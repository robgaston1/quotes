$(document).ready(function() {
  ...
  },
  {
    ...
    "permalink": "http://quotes.stormconsultancy.co.uk/quotes/1"
        ...
        var link = quotes[index].permalink;
        var author = quotes[index].author;
        
        $("#phrase").text(newquote);
        $("#auth").text(author);
        var tweet = (newquote.substr(0,95)) + "..." + author + " " + link;
        $("#tweet").html("<a class=\"twitter-share-button\" target=\"blank\" href=\"https://twitter.com/intent/tweet?text="+tweet+"\"><button id=\"tweet\"><i class=\"fa fa-twitter\" aria-hidden=\"true\"></i> Tweet</button></a>");
        }

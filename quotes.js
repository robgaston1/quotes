$(document).ready(function() {
    ...
    function genQuote() {
            ...
            $("#tweet").html("<a class=\"twitter-share-button\" href=\"https://twitter.com/intent/tweet?text="+tweet+"\"><button class=\"btn btn-primary\" id=\"tweet\"><i class=\"fa fa-twitter\" aria-hidden=\"true\"></i> Tweet</button></a>");
        });
      }
